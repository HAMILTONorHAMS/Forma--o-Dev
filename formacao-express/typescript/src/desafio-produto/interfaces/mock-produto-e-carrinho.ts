...
export const carrinho: Carrinho[] = [
  { produto: produtoMock[2], quantidade: 3 },
  { produto: produtoMock[5], quantidade: 5 },
  { produto: produtoMock[7], quantidade: 6 },
  { produto: produtoMock[1], quantidade: 7 },
  { produto: produtoMock[3], quantidade: 8 },
  { produto: produtoMock[4], quantidade: 10 },
];
